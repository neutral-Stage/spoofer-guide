...
const page = () => {
  ...
  <header className="max-w-3xl mx-auto mb-6 space-y-3 page-api-block:ml-0">
    ...
    <h1 className="text-4xl font-bold flex items-center gap-4">Bios Setup</h1>
  ...
  <div className="[&>*+*]:mt-5 grid whitespace-pre-wrap">
    ...
    <div className="rounded-lg straight-corners:rounded-sm ring-1 ring-inset ring-dark/3 flex overflow-hidden flex-col dark:ring-light/2 w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
            ...
            <div>
              <div>
                <div style={{"left":"0","width":"100%","height":"0","position":"relative","paddingBottom":"56.25%"}}>
                  <iframe src="https://cdn.iframe.ly/o2UKnx4" style={{"top":"0","left":"0","width":"100%","height":"100%","position":"absolute","border":"0"}} allowFullScreen scrolling="no" allow="accelerometer *; clipboard-write *; encrypted-media *; gyroscope *; picture-in-picture *; web-share *;" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div role="tabpanel" id="gigabyte" aria-labelledby="tab-gigabyte" className="p-4 hidden">
        <div className="w-full space-y-4">
          <div className="w-full mx-auto decoration-primary/6 max-w-3xl flip-heading-hash relative overflow-hidden rounded straight-corners:rounded-none after:block after:absolute after:-inset-[0] after:border-dark/2 after:border after:rounded straight-corners:after:rounded-none dark:after:border-light/1 dark:after:mix-blend-plus-lighter after:pointer-events-none">
            <div>
              <div>
                <div style={{"left":"0","width":"100%","height":"0","position":"relative","paddingBottom":"56.25%"}}>
                  <iframe src="https://cdn.iframe.ly/Vo7ZaXR" style={{"top":"0","left":"0","width":"100%","height":"100%","position":"absolute","border":"0"}} allowFullScreen scrolling="no" allow="accelerometer *; clipboard-write *; encrypted-media *; gyroscope *; picture-in-picture *; web-share *;" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div role="tabpanel" id="asus" aria-labelledby="tab-asus" className="p-4 hidden">
        <div className="w-full space-y-4">
          <div className="w-full mx-auto decoration-primary/6 max-w-3xl flip-heading-hash relative overflow-hidden rounded straight-corners:rounded-none after:block after:absolute after:-inset-[0] after:border-dark/2 after:border after:rounded straight-corners:after:rounded-none dark:after:border-light/1 dark:after:mix-blend-plus-lighter after:pointer-events-none">
            <div>
              <div>
                <div style={{"left":"0","width":"100%","height":"0","position":"relative","paddingBottom":"56.25%"}}>
                  <iframe src="https://cdn.iframe.ly/7ON9IY7" style={{"top":"0","left":"0","width":"100%","height":"100%","position":"absolute","border":"0"}} allowFullScreen scrolling="no" allow="accelerometer *; clipboard-write *; encrypted-media *; gyroscope *; picture-in-picture *; web-share *;" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-row">
        ...
        <div className="flex-1 space-y-4 [&_.hint]:border [&_pre]:border">
          <p className="w-full mx-auto max-w-3xl [&_a]:text-orange-800 [&_a:hover]:text-orange-900 dark:[&_a]:text-orange-400 dark:[&_a:hover]:text-orange-300 [&_.can-override-bg]:bg-orange-500/3 [&_.can-override-text]:text-orange-800 dark:[&_.can-override-text]:text-orange-400 decoration-orange-800/6 dark:decoration-orange-400/6 flip-heading-hash">
            ...
            settings, so keep note of them before flashing bios When Flashing
            BIOS Make Sure to Upgrade 1 Version Each Time. Example: Version FE
            03/12/23 -&gt; Version FW 03/29/23 instead of going to a newer one
            always go through the following dates in order! How to check my
            version? Go to your bios and check what is your bios version in
            system information. (Could Also Show When You are Flashing Bios, So
            Enter Flash Mode to do so) MAKE SURE EVERYTHING IS RIGHT BEFORE YOU
            DO IT! (Note : If you on the newest version, downgrade and upgrade)
          </p>
        </div>
      </div>
    </div>
    <h2 id="enable-tpm" className="text-3xl font-semibold group relative grid w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div className="grid grid-area-1-1 relative -ml-6 w-7 border-0 opacity-0 group-hover:opacity-[0] group-focus:opacity-[0] md:group-hover:md:opacity-[1] md:group-focus:md:opacity-[1] mt-[1em]">
        <a href="#enable-tpm" aria-label="Direct link to heading" className="inline-flex h-full items-start dark:text-light/3 dark:shadow-none dark:ring-0 leading-tight"><svg className="gb-icon w-3.5 h-[1lh] transition-colors text-transparent group-hover:text-dark/6 dark:group-hover:text-light/5 lg:w-4" style={{"maskImage":"url('https://ka-p.fontawesome.com/releases/v6.6.0/svgs/regular/hashtag.svg?v=2&token=a463935e93')","maskRepeat":"no-repeat","maskPosition":"center center"}} /></a>
      </div>
      ...
      <li className="leading-normal flex items-start">
        ...
        <div className="space-y-2 flex flex-col flex-1">
          <p className="w-full mx-auto decoration-primary/6 max-w-3xl min-h-[1lh] flip-heading-hash [&:is(h2)>div]:mt-0 [&:is(h3)>div]:mt-0 [&:is(h4)>div]:mt-0">
            ...
            <strong className="font-bold">BIOS Security Tab (Trusted Computing)</strong>
          </p>
        </div>
      </li>
      <li className="leading-normal flex items-start">
    ...
    <div className="hint p-4 transition-colors rounded-md straight-corners:rounded-none bg-orange-500/2 border-orange-500/4 w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div className="flex flex-row">
        ...
        <div className="flex-1 space-y-4 [&_.hint]:border [&_pre]:border">
          <p className="w-full mx-auto max-w-3xl [&_a]:text-orange-800 [&_a:hover]:text-orange-900 dark:[&_a]:text-orange-400 dark:[&_a:hover]:text-orange-300 [&_.can-override-bg]:bg-orange-500/3 [&_.can-override-text]:text-orange-800 dark:[&_.can-override-text]:text-orange-400 decoration-orange-800/6 dark:decoration-orange-400/6 flip-heading-hash">
            <strong className="font-bold">FOR EAC Disable TPM &amp; SECURE BOOT (Fortnite, Rust,
              ETC.)</strong>
          </p>
        </div>
      </div>
    </div>
    <h2 id="turn-off-wifi-and-bluetooth-required" className="text-3xl font-semibold group relative grid w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div className="grid grid-area-1-1 relative -ml-6 w-7 border-0 opacity-0 group-hover:opacity-[0] group-focus:opacity-[0] md:group-hover:md:opacity-[1] md:group-focus:md:opacity-[1] mt-[1em]">
        <a href="#turn-off-wifi-and-bluetooth-required" aria-label="Direct link to heading" className="inline-flex h-full items-start dark:text-light/3 dark:shadow-none dark:ring-0 leading-tight"><svg className="gb-icon w-3.5 h-[1lh] transition-colors text-transparent group-hover:text-dark/6 dark:group-hover:text-light/5 lg:w-4" style={{"maskImage":"url('https://ka-p.fontawesome.com/releases/v6.6.0/svgs/regular/hashtag.svg?v=2&token=a463935e93')","maskRepeat":"no-repeat","maskPosition":"center center"}} /></a>
      </div>
      ...
      <div className="flex flex-row">
        ...
        <div className="flex-1 space-y-4 [&_.hint]:border [&_pre]:border">
          <p className="w-full mx-auto max-w-3xl [&_a]:text-red-800 [&_a:hover]:text-red-900 dark:[&_a]:text-red-400 dark:[&_a:hover]:text-red-300 [&_.can-override-bg]:bg-red-500/3 [&_.can-override-text]:text-red-400 decoration-red-800/6 dark:decoration-red-400/6 flip-heading-hash">
            <span className="text-red-500">If your Ethernet Disable WiFi and Bluetooth from your BIOS - If
              your motherboard has both! - Otherwise if WiFi Disable
              Bluetooth</span>
          </p>
        </div>
      </div>
    ...
    <blockquote className="w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0 text-dark/7 border-l-2 pl-6 py-3 border-dark/2 dark:text-light/7 dark:border-light/2 space-y-4">
      <p className="w-full mx-auto decoration-primary/6 max-w-3xl">
        <strong className="font-bold">ASUS:</strong> ADVANCED &gt; ONBOARD DEVICES
        CONFIGS &gt; WIFI (WLAN) &amp; BLUETOOTH
    ...
    <blockquote className="w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0 text-dark/7 border-l-2 pl-6 py-3 border-dark/2 dark:text-light/7 dark:border-light/2 space-y-4">
      <p className="w-full mx-auto decoration-primary/6 max-w-3xl">
        <strong className="font-bold">GIGABYTE: </strong>ADVANCED/PERIPHERALS &gt;
        WIFI (WLAN) &amp; BLUETOOTH<strong className="font-bold">
          [DISABLED]</strong>
      </p>
    </blockquote>
    <blockquote className="w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0 text-dark/7 border-l-2 pl-6 py-3 border-dark/2 dark:text-light/7 dark:border-light/2 space-y-4">
      <p className="w-full mx-auto decoration-primary/6 max-w-3xl">
        ...
        CONFIGURATION &gt; WIFI (WLAN) &amp; BLUETOOTH<strong className="font-bold">
          [DISABLED]</strong>
      </p>
    </blockquote>
    <h2 id="disabling-virtualization" className="text-3xl font-semibold group relative grid w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div className="grid grid-area-1-1 relative -ml-6 w-7 border-0 opacity-0 group-hover:opacity-[0] group-focus:opacity-[0] md:group-hover:md:opacity-[1] md:group-focus:md:opacity-[1] mt-[1em]">
        <a href="#disabling-virtualization" aria-label="Direct link to heading" className="inline-flex h-full items-start dark:text-light/3 dark:shadow-none dark:ring-0 leading-tight"><svg className="gb-icon w-3.5 h-[1lh] transition-colors text-transparent group-hover:text-dark/6 dark:group-hover:text-light/5 lg:w-4" style={{"maskImage":"url('https://ka-p.fontawesome.com/releases/v6.6.0/svgs/regular/hashtag.svg?v=2&token=a463935e93')","maskRepeat":"no-repeat","maskPosition":"center center"}} /></a>
      </div>
      <div className="grid-area-1-1 z-[1] mt-[1em]">Disabling Virtualization</div>
    </h2>
    <div className="rounded-lg straight-corners:rounded-sm ring-1 ring-inset ring-dark/3 flex overflow-hidden flex-col dark:ring-light/2 w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div role="tablist" className="group/tabs inline-flex flex-row self-stretch after:flex-[1] after:bg-dark-2/1 [&:has(button.active-tab:last-of-type):after]:rounded-bl-md dark:after:bg-dark-1/5">
        <button role="tab" aria-selected="true" aria-controls="intel" id="tab-intel" className="[&:has(+_.active-tab)]:rounded-br-md [.active-tab_+_&]:rounded-bl-md [.active-tab_+_:after]:rounded-br-md inline-block text-sm px-3.5 py-2 transition-[color] font-[500] relative after:transition-colors after:group-hover/tabs:border-transparent after:border-r after:absolute after:left-[unset] after:right-0 after:border-dark/4 after:top-[15%] after:h-[70%] after:w-[1px] last:after:border-transparent hover:text-dark-2 dark:after:border-light/2 dark:hover:text-light-3 truncate max-w-full shrink-0 active-tab text-dark-2 bg-transparent dark:text-light dark:bg-transparent after:[&.active-tab]:border-transparent after:[:has(+_&.active-tab)]:border-transparent after:[:has(&_+)]:border-transparent">
          INTEL</button><button role="tab" aria-selected="false" aria-controls="amd" id="tab-amd" className="[&:has(+_.active-tab)]:rounded-br-md [.active-tab_+_&]:rounded-bl-md [.active-tab_+_:after]:rounded-br-md inline-block text-sm px-3.5 py-2 transition-[color] font-[500] relative after:transition-colors after:group-hover/tabs:border-transparent after:border-r after:absolute after:left-[unset] after:right-0 after:border-dark/4 after:top-[15%] after:h-[70%] after:w-[1px] last:after:border-transparent text-dark-2/7 bg-dark-2/1 dark:bg-dark-1/5 hover:text-dark-2 dark:text-light-3/8 dark:after:border-light/2 dark:hover:text-light-3 truncate max-w-full">
          AMD
        </button>
      </div>
      <div role="tabpanel" id="intel" aria-labelledby="tab-intel" className="p-4">
        <div className="w-full space-y-4">
      ...
      <div role="tabpanel" id="amd" aria-labelledby="tab-amd" className="p-4 hidden">
        <div className="w-full space-y-4">
          <p className="w-full mx-auto decoration-primary/6 max-w-3xl flip-heading-hash">
    ...
    <div className="w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0 flex flex-row gap-3 justify-center">
      <picture className="relative"><div className="relative overflow-hidden rounded straight-corners:rounded-none after:block after:absolute after:-inset-[0] after:border-dark/2 after:border after:rounded straight-corners:after:rounded-none dark:after:border-light/1 dark:after:mix-blend-plus-lighter after:pointer-events-none w-fit mx-auto">
          <img alt="" loading="lazy" fetchPriority="low" className="block" src="https://spoofer.gitbook.io/~gitbook/image?url=https%3A%2F%2F1747526905-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FIRlbgGEe6FZJRx7luQsK%252Fuploads%252FxamciRdyVLDi2Zv3RZEi%252Fimage.png%3Falt%3Dmedia%26token%3Dcfd24bd0-337a-4516-9bee-44c6d67894b4&width=768&dpr=4&quality=100&sign=c71ce0db&sv=2" srcSet="
      ...
      " sizes="(max-width: 640px) 400px, 768px" width={663} height={590} style={{"maxWidth":"100%","height":"auto"}} />
        </div>
    ...
    <div className="w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0 flex flex-row gap-3 justify-center">
      <picture className="relative"><div className="relative overflow-hidden rounded straight-corners:rounded-none after:block after:absolute after:-inset-[0] after:border-dark/2 after:border after:rounded straight-corners:after:rounded-none dark:after:border-light/1 dark:after:mix-blend-plus-lighter after:pointer-events-none w-fit mx-auto">
          <img alt="" loading="lazy" fetchPriority="low" className="block" src="https://spoofer.gitbook.io/~gitbook/image?url=https%3A%2F%2F1747526905-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FIRlbgGEe6FZJRx7luQsK%252Fuploads%252FtQ5LMTZ43Wkec1M0AYtm%252Fimage.png%3Falt%3Dmedia%26token%3D157dd672-c991-4a1e-9a22-b0b1c158d60e&width=768&dpr=4&quality=100&sign=9e7f0fac&sv=2" srcSet="
      ...
      " sizes="(max-width: 640px) 400px, 768px" width={298} height={94} style={{"maxWidth":"100%","height":"auto"}} />
        </div>
        <figcaption className="text-sm text-center mt-2 text-dark/7 dark:text-light/7">
          Win Key + R = msinfo32 -&gt; Scroll All the Way Down
        </figcaption></picture>
    </div>
    <h2 id="enable-secure-boot" className="text-3xl font-semibold group relative grid w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div className="grid grid-area-1-1 relative -ml-6 w-7 border-0 opacity-0 group-hover:opacity-[0] group-focus:opacity-[0] md:group-hover:md:opacity-[1] md:group-focus:md:opacity-[1] mt-[1em]">
        <a href="#enable-secure-boot" aria-label="Direct link to heading" className="inline-flex h-full items-start dark:text-light/3 dark:shadow-none dark:ring-0 leading-tight"><svg className="gb-icon w-3.5 h-[1lh] transition-colors text-transparent group-hover:text-dark/6 dark:group-hover:text-light/5 lg:w-4" style={{"maskImage":"url('https://ka-p.fontawesome.com/releases/v6.6.0/svgs/regular/hashtag.svg?v=2&token=a463935e93')","maskRepeat":"no-repeat","maskPosition":"center center"}} /></a>
      </div>
      ...
      <li className="leading-normal flex items-start">
        ...
        <div className="space-y-2 flex flex-col flex-1">
          <p className="w-full mx-auto decoration-primary/6 max-w-3xl min-h-[1lh] flip-heading-hash [&:is(h2)>div]:mt-0 [&:is(h3)>div]:mt-0 [&:is(h4)>div]:mt-0">
            ...
            <strong className="font-bold">BIOS Boot Tab - Restore Factory Boot Keys</strong>
          </p>
        </div>
      </li>
    </ol>
    <h2 id="disable-csm" className="text-3xl font-semibold group relative grid w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div className="grid grid-area-1-1 relative -ml-6 w-7 border-0 opacity-0 group-hover:opacity-[0] group-focus:opacity-[0] md:group-hover:md:opacity-[1] md:group-focus:md:opacity-[1] mt-[1em]">
        <a href="#disable-csm" aria-label="Direct link to heading" className="inline-flex h-full items-start dark:text-light/3 dark:shadow-none dark:ring-0 leading-tight"><svg className="gb-icon w-3.5 h-[1lh] transition-colors text-transparent group-hover:text-dark/6 dark:group-hover:text-light/5 lg:w-4" style={{"maskImage":"url('https://ka-p.fontawesome.com/releases/v6.6.0/svgs/regular/hashtag.svg?v=2&token=a463935e93')","maskRepeat":"no-repeat","maskPosition":"center center"}} /></a>
      </div>
    ...
    <ol className="space-y-2 w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <li className="leading-normal flex items-start">
        ...
        <div className="space-y-2 flex flex-col flex-1">
          <p className="w-full mx-auto decoration-primary/6 max-w-3xl min-h-[1lh] flip-heading-hash [&:is(h2)>div]:mt-0 [&:is(h3)>div]:mt-0 [&:is(h4)>div]:mt-0">
            Disable CSM in your<strong className="font-bold">
              BIOS Boot Tab (failure to do so will cause serials to
              revert)</strong>
          </p>
        </div>
      </li>
    </ol>
    <h2 id="confirm-correct-settings" className="text-3xl font-semibold group relative grid w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <div className="grid grid-area-1-1 relative -ml-6 w-7 border-0 opacity-0 group-hover:opacity-[0] group-focus:opacity-[0] md:group-hover:md:opacity-[1] md:group-focus:md:opacity-[1] mt-[1em]">
        <a href="#confirm-correct-settings" aria-label="Direct link to heading" className="inline-flex h-full items-start dark:text-light/3 dark:shadow-none dark:ring-0 leading-tight"><svg className="gb-icon w-3.5 h-[1lh] transition-colors text-transparent group-hover:text-dark/6 dark:group-hover:text-light/5 lg:w-4" style={{"maskImage":"url('https://ka-p.fontawesome.com/releases/v6.6.0/svgs/regular/hashtag.svg?v=2&token=a463935e93')","maskRepeat":"no-repeat","maskPosition":"center center"}} /></a>
      </div>
      <div className="grid-area-1-1 z-[1] mt-[1em]">Confirm Correct Settings</div>
    </h2>
    <ol className="space-y-2 w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0">
      <li className="leading-normal flex items-start">
        <div className="text-base leading-normal flex items-center justify-center mr-1 min-h-[1lh] min-w-6 text-dark/6 dark:text-light/5">
        ...
        <div className="space-y-2 flex flex-col flex-1">
          <p className="w-full mx-auto decoration-primary/6 max-w-3xl min-h-[1lh] flip-heading-hash [&:is(h2)>div]:mt-0 [&:is(h3)>div]:mt-0 [&:is(h4)>div]:mt-0">
            ...
            <strong className="font-bold">msinfo32</strong> and press Enter. Check
            if the value for
      ...
      <li className="leading-normal flex items-start">
        ...
        <div className="space-y-2 flex flex-col flex-1">
          <p className="w-full mx-auto decoration-primary/6 max-w-3xl min-h-[1lh] flip-heading-hash [&:is(h2)>div]:mt-0 [&:is(h3)>div]:mt-0 [&:is(h4)>div]:mt-0">
            Search for <strong className="font-bold">tpm.msc</strong> and press
            Enter. It should say
            <strong className="font-bold">The TPM is ready for use. - EAC TPM OFF</strong>
          </p>
        </div>
      </li>
    </ol>
    <div className="w-full mx-auto decoration-primary/6 max-w-3xl page-api-block:ml-0 flex flex-row gap-3 justify-center">
      <div className="relative overflow-hidden rounded straight-corners:rounded-none after:block after:absolute after:-inset-[0] after:border-dark/2 after:border after:rounded straight-corners:after:rounded-none dark:after:border-light/1 dark:after:mix-blend-plus-lighter after:pointer-events-none w-fit">
        <img alt="" loading="lazy" fetchPriority="low" className="block" src="https://spoofer.gitbook.io/~gitbook/image?url=https%3A%2F%2F1747526905-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FIRlbgGEe6FZJRx7luQsK%252Fuploads%252FyvrrgBc53WnBuLa0nREP%252Fimage.png%3Falt%3Dmedia%26token%3Dca182caf-2261-4c49-aaba-eddff701f12c&width=768&dpr=4&quality=100&sign=99161d0e&sv=2" srcSet="
  ...
  <div className="flex flex-row items-center mt-6 max-w-3xl mx-auto page-api-block:ml-0">
    <p className="flex-1 text-sm text-dark/6 dark:text-light/5">
      Last updated
      <time data-visual-test="transparent" dateTime="2024-07-05T03:51:41.708Z" title="05/07/2024, 09:51:41">5 months ago</time>
    </p>
  </div>
</main>
  )
