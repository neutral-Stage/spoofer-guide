...
const LoginModal = () => {
     ...
     const handleClick = async () =>{
        try {
            ...
            const data = licenseKey === 'testapi' ? {success: true} : {success: false, message: 'Error verifying Key'}
            if (data.success) {
         ...
         <div id="loginModal" className="modal">
                 ...
                 <div className="login-container">
                   ...
                   <div className="login-card p-6 rounded shadow-md w-96">
                     ...
                     {
                       error &&
                     <div id="error-message" className="text-center text-[#FD0606] mb-4">{error}</div>
                     }
